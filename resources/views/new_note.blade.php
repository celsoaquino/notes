            ...
            <form action="{{ route('store')}}" method="POST">
                ...
                <div class="p-4 md:p-5">
                    <div class="max-w-full ">
                        ...
                        <input type="text" id="input-label" name="text_title" value="{{ old('text_title') }}"
                    ...
                    <div class="max-w-full mt-4">
                        ...
                        <textarea id="textarea-label" name="text_note"
                                  class="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm !outline-none focus:border-blue-500"
                                  rows="3" placeholder="Say hi...">{{ old('text_note') }}</textarea>
                        @error('text_note')
                        <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="flex justify-end">
                        ...
                        <button type="submit" class="mt-3 mr-1 py-2 px-3 inline-flex justify-center items-center gap-x-5 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                           href="{{ route('home') }}">
                            Save
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                 stroke="currentColor" class="size-6">
